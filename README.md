...
**Aspiring Gen AI Engineer.** I love building with LLMs, agents, and Python — turning models into working software. Strong foundation in applied ML and data, now focused on shipping AI-powered applications.
...
| **APIs & Serving** | REST APIs, FastAPI *(learning)* |
| **Visualization** | Matplotlib, Tableau, Power BI |
| **Tooling** | Git & GitHub, Jupyter, Excel |
